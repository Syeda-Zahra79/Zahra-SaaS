  ...
  return (
    ...
    <form action={postData}>
      <CardHeader>
        ...
        <CardDescription>Right here you can now edit note.</CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col gap-y-5">
          ...
          <div className="flex flex-col gap-y-2">
              ...
              <Textarea name="description" placeholder="Describe your note as you want"  defaultValue={data?.description}/>
          </div>
      </CardContent>
